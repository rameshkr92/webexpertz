...
<head>
    <meta charset="utf-8">
    <title>Home :: webExpertz</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="Progressive — Responsive Multipurpose HTML Template">
    <meta name="author" content="itembridge.com">
    <meta class="viewport" name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="shortcut icon" href="{{ URL::asset('public/img/front/favicon.ico')}}">

    <!-- Font -->
    <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Arimo:400,700,400italic,700italic'>

    <!-- Plagins CSS -->
    {{--<link rel="stylesheet" href="{{ URL::asset('public/css/front/buttons/buttons.css')}}">--}}
    {{--<link rel="stylesheet" href="{{ URL::asset('public/css/front/buttons/social-icons.css')}}">--}}
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/jslider.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/settings.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/jquery.fancybox.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/animate.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/video-js.min.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/morris.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/royalslider/royalslider.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/royalslider/skins/minimal-white/rs-minimal-white.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/layerslider/layerslider.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/ladda.min.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/datepicker.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/jquery.scrollbar.css')}}">

    <!-- Theme CSS -->
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/style.css')}}">

    <!-- Responsive CSS -->
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/responsive.css')}}">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/customizer/pages.css')}}">
    <link rel="stylesheet" href="{{ URL::asset('public/css/front/customizer/home-pages-customizer.css')}}">

    <!-- IE Styles-->
    <link rel='stylesheet' href="{{ URL::asset('public/css/front/ie/ie.css')}}">

    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
    <link rel='stylesheet' href="{{ URL::asset('public/css/front/ie/ie8.css')}}">
    <![endif]-->
</head>
                                                    ...
                                                    <ul class="sub">
                                                        <li class="sub-wrapper">
                                                            ...
                                                            <div class="promo-block">
                                                                <a href="#">
                                                                    <img src="{{ URL::asset('public/img/front/content/megamenu-big.png')}}" width="253" height="457" alt="">
                                                                </a>
                                                            </div><!-- .promo-block -->
                                                        </li>
                                                    </ul><!-- .sub -->
                                                    ...
                                                    <ul class="sub">
                                                        <li class="sub-wrapper">
                                                            ...
                                                            <div class="promo-block bg">
                                                                <img src="{{ URL::asset('public/img/front/content/menu-elements.png')}}" width="240" height="434" alt="">
                                                            </div><!-- .promo-block -->
                                                        </li>
                                                    </ul>
                                                </li>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-11.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-11.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-12.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-12.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-13.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-13.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-14.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-14.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-5.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-5.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-6.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-6.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-7.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-7.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
					...
					<path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					  ...
					  <path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
                                ...
                                <div class="col-sm-3 col-md-3 product rotation">
                                    <div class="default">
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-8.png')}}" alt="" title="" width="270" height="270">
                                        </a>
                                        <div class="product-description">
                                            <div class="vertical">
                                                <h3 class="product-name">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <div class="price">$1, 449.00</div>
                                        <a href="shop-product-view.html" class="product-image">
                                            <img src="{{ URL::asset('public/img/front/content/product-8.png')}}" alt="" title="" width="70" height="70">
                                        </a>
                                        <ul>
                                            <li>117 cm / 46"LCD TV</li>
                                            <li>Full HD 3D &amp; 2D</li>
			...
			--><div class="make-wrapper">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-1-84.png')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                                    <div class="meta">
                                ...
                                <li>
                                    <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-2-84.png')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                                    <div class="meta">
                                        <span>Mike Example</span>,
                                        <span class="time">03.11.2013, 10:45:</span>
                                    </div>
                                ...
                                <li>
                                    <img class="image img-circle" src="{{ URL::asset('public/img/front/content/product-3-84.png')}}" alt="" title="" width="84" height="84" data-appear-animation="rotateIn">
                                    <div class="meta">
                                        <span>Mike Example</span>,
                                        <span class="time">03.11.2013, 10:45:</span>
                                    </div>
